...
https://wikis.ec.europa.eu/display/jrcdataspaceswiki/JRC+Data+Spaces+Knowledge+Base
...
- collection of existing standards and candidates for BBs tech space
...
- Somce concepets such as Feature or Bounding Box are used by many standards but sometimes with different meaning. Redefining is risky as they are used a lot.
...
This part was by presenter considered too technical for the audience and time constraints and she moved further.

A more coherent suite of standards
tested example

Reusability of standards is the key
...
Current devs: check for example ISO 19115-4 Metadata -Part 4 about JSON
...
Dimentions of interoperability: from Intra-Domain Space to Inter-Common European Data Space Collaboration

Interoperability is part of the Architecture as there should be data and control plance interoperability
...
Data interoperability in INSPIRE: what should improve in the future?
...
3. Usge Open data and the Operating Costs

### SITRA

Independent by EU Parliament

Some docs produced by SITRA: [Towards a Holistic EU Data Governance](https://www.sitra.fi/en/publications/towards-a-holistic-eu-data-governance/#foreword)
