---
title: 10 years GEOPUNT
background:
  img: /assets/backgrounds/GEOPUNT10YEARS.png
  by: [Databank Ondergrond Vlaanderen](https://www.dov.vlaanderen.be/)
author: Damiano Oldoni
tags: [Data, Geospatial, Vlaamse Overheid, Flemish Authority, 2024, Belgium, Gent]
toc: true
comments: false
published: true
---
...
Presenter: Katia Beringhs – Head GIS & IT applications of [Vlaamse Milieumaatschappij](https://en.vmm.be/) - VMM
...
Many type data are needed to forcast flood levels. Many of them are included in the [Flemish Digital Height Model](https://www.vlaanderen.be/digitaal-vlaanderen/onze-oplossingen/earth-observation-data-science-eodas/het-digitaal-hoogtemodel), also available via Geopunt.
...
- Actuele no regret zones (PFAS), one of the very last layers 
